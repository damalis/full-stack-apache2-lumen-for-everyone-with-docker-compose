# [full stack apache2 Lumen for everyone with docker compose](https://github.com/damalis/full-stack-apache2-lumen-for-everyone-with-docker-compose)

If You want to build a website with Lumen "webapp" at short time; 

#### Full stack Apache2 Lumen "webapp":
...
```
git clone https://github.com/damalis/full-stack-apache2-lumen-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-apache2-lumen-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
